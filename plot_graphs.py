...
loss_complex_real= pd.read_csv("loss_complex_real.csv").values
plt.errorbar(
...
loss_complex_hybrid= pd.read_csv("loss_complex_hybrid.csv").values
plt.errorbar(
...
loss_complex_phase= pd.read_csv("loss_complex_phase.csv").values
plt.errorbar(
...
loss_complex_magnitude= pd.read_csv("loss_complex_magnitude.csv").values
plt.errorbar(
...
loss_complex_hybrid_norm= pd.read_csv("loss_complex_hybrid_norm.csv").values
plt.errorbar(
...
loss_rope= pd.read_csv("loss_rope.csv").values
plt.errorbar(
...
loss_learned= pd.read_csv("loss_learned.csv").values
plt.errorbar(
...
loss_sine= pd.read_csv("loss_sine.csv").values
plt.errorbar(
